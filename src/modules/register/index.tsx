...
const index = () => {
    ...
    return (
        <div>
            {loadingRegister && <LinearProgress style={{ width: "100%", zIndex: 1 }} />}
                    ...
                    <div className={classes.form}>
                        ...
                        >
                            {({ values, setFieldValue, errors }) => (
                                <Form>
                                    <Grid component="div" className={classes.contentAvatarProfile}>
                                        <ImgCrop rotate>
                                            <Upload
                                                name="avatar"
                                                ...
                                                beforeUpload={(file: RcFile, fileList: RcFile[]) => handleBeforeUpload(file, fileList, setFieldValue)}
                                                onPreview={onPreview}   
                                            > 
                                                {imgProfile ? <img 
                                    ...
                                    <div className={classes.formButtons}>
                                        ...
                                        >
                                            Registrarse{" "}{loadingRegister && <CircularProgress size={14} />}
                                        </Button>
                                    </div>
                                    <Link to="/login" style={{ marginTop: 20 }}>
                                        <Typography variant="caption" component="span">Iniciar Sesión</Typography>
                                    </Link>
                                </Form>
                            )}
                        </Formik>
